...
<head>
    ...
    <title>Automatic Generate Question | Pronoun Collection</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/pronoun_collection" class="waves-effect active">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Pronoun Collection</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="/">Home</a></li>
                            <li class="active">Pronoun Collection</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Add Pronoun</h3>
                            <form method="POST" action="/pronoun_collection/add">
                                <div class="input-group m-t-10">
                                    <input type="text" id="example-input2-group2" name="example-input2-group2" class="form-control" placeholder="Pronoun">
                                    <span class="input-group-btn">
                            ...
                            <h3 class="box-title m-b-10 m-t-20">All Pronoun</h3>
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        {% for i in range(0, len_pronoun) %}
                                            <tr>
                                            <td>{{list_pronoun[i]}}</td>
                                            <td>
                                                <div class="col-lg-4 col-sm-8 col-xs-12">
                                                    <form method="POST" action="/pronoun_collection/delete">
                                                        <input type="hidden" name="id_pronoun" value="{{i}}">
