...
<div class="container mt-4">
    ...
    <div class="row pt-3">
        ...
        <div class="p-2 pb-1">
            ...
            <select class="form-select" aria-label="option" onchange="showDiv(this)">
        ...
        <a href="/demo/preview-passage">
            <button class="btn bg-color-primary text-white float-end ps-5 pe-5 mt-5">Generate</button>
        </a>
        <!-- </form> -->
    </div>
